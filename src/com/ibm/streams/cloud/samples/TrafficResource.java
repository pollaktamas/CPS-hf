...
public class TrafficResource {
	   ...
	   // This is teh information provided in the vcap for the bound Streams service 
        ...
        // DATA
        private static JSONObject dataToPage;
	...
	private void firstTimeInit(URI uriBase) {
    	...
    	if (instanceOK) { 
		  ...
		  jobName = "Weather_" + uriBase.getHost();  
	...
	private String checkJob() {
		...
		if (itr.hasNext()) {
			...
			if (result.equals("UNKNOWN")) {
				// Weather job was not in list of jobs returned 
   ...
   public JSONObject stopInstance()    {
    ...
    public JSONObject getsubmit(String uri)    {
        ...
        result.put("APIstatus", "starting");
       	...
       	final String fileName = "Weather.sab";
